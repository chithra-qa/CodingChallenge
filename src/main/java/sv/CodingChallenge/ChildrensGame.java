...
public class ChildrensGame {
	...
	/*
	 * Function to find the elimination order of children after one in every k-th
	 * position is eliminated in a circle of 'n' kids
	 */
	...
	public static void main(String args[]) {
		...
		eliminationOrder.remove(eliminationOrder.size() - 1);
